...
import { GameState } from "./class/Game";
...
describe("Socket.IO Server Tests", () => {
  ...
  beforeAll((done) => {
    start(PORT);
    (io as SocketIOServer).on("connection", (socket) => {
      serverSocket = socket;
    });
  ...
  describe("joinGame", () => {
    it("should create a new game and join it", (done) => {
      ...
      clientSocket.on("gameState", (gameState: GameState) => {
    ...
    it("should allow multiple players to join the same game", (done) => {
      ...
      clientSocket.once("gameState", () => {
        ...
        client2.once("gameState", (gameState: GameState) => {
    ...
    it("should emit error when trying to join a started game", (done) => {
      ...
      clientSocket.once("gameState", () => {
        ...
        clientSocket.once("gameState", () => {
          ...
          client2.once("error", (error: Error) => {
            expect(error).toBe("Cannot join started game");
            client2.disconnect();
            done();
          });
        });
  ...
  describe("startGame", () => {
    it("should start the game when host requests", (done) => {
      ...
      clientSocket.once("gameState", () => {
        ...
        clientSocket.once("gameState", (gameState: GameState) => {
    ...
    it("should not start if not host", (done) => {
      ...
      clientSocket.once("gameState", () => {
        ...
        client2.once("gameState", (initialState: GameState) => {
    ...
    it("should handle player disconnect", (done) => {
      ...
      clientSocket.once("gameState", () => {
        ...
        client2.once("gameState", (gameState: GameState) => {
          ...
          clientSocket.once("gameState", (updatedState: GameState) => {
      ...
      clientSocket.once("gameState", () => {
        ...
        setTimeout(() => {
          ...
          client3.on("connect", () => {
            ...
            client3.once("gameState", (gameState: GameState) => {
