...
const mockedGetShapeTemplate = getShapeTemplate as jest.MockedFunction<
  typeof getShapeTemplate
>;
const mockedRotateShape = rotateShape as jest.MockedFunction<
  typeof rotateShape
>;
...
describe("Piece", () => {
  ...
  describe("constructor", () => {
    ...
    it("utilise le shape passé sans appeler getShapeTemplate", () => {
      ...
      const piece = new Piece(kind, 5, 10, 2 as Rotation, customShape);
  ...
  describe("mouvements", () => {
    it("moveLeft retourne une nouvelle Piece avec x - 1 (sans muter l'original)", () => {
      const kind = KIND_T;
      const piece = new Piece(kind, 4, 5, 1 as Rotation, baseShape);
    ...
    it("moveRight retourne une nouvelle Piece avec x + 1", () => {
      const piece = new Piece(KIND_L, 2, 5, 0 as Rotation, baseShape);
    ...
    it("moveDown retourne une nouvelle Piece avec y + 1", () => {
      const piece = new Piece(KIND_J, 2, 5, 0 as Rotation, baseShape);
  ...
  describe("rotate", () => {
    it("incrémente la rotation modulo 4 et utilise rotateShape", () => {
      const piece = new Piece(KIND_S, 1, 2, 1 as Rotation, baseShape);

      const rotated = piece.rotate();

      expect(rotated.rotation).toBe(((1 + 1) % 4) as Rotation);
    ...
    it("revient à 0 après 3 -> 0 (modulo 4)", () => {
      const piece = new Piece(KIND_Z, 0, 0, 3 as Rotation, baseShape);
  ...
  describe("getAbsoluteCoords", () => {
    it("retourne les coordonnées absolues en ajoutant x et y de la piece", () => {
      const piece = new Piece(KIND_I, 10, 20, 0 as Rotation, baseShape);
  ...
  describe("isValidPosition", () => {
    const makeEmptyBoard = (width: number, height: number) =>
    ...
    it("retourne true quand toutes les cases sont dans les limites et vides", () => {
      ...
      const piece = new Piece(KIND_I, 3, 5, 0 as Rotation, baseShape);
    ...
    it("retourne false si une coordonnée est en dehors du board (gauche)", () => {
      const board = makeEmptyBoard(10, 20);
      const piece = new Piece(KIND_I, -1, 5, 0 as Rotation, baseShape);
    ...
    it("retourne false si une coordonnée est en dehors du board (droite)", () => {
      ...
      const piece = new Piece(KIND_I, 4, 0, 0 as Rotation, baseShape);
    ...
    it("retourne false si une coordonnée est en dessous du board", () => {
      ...
      const piece = new Piece(KIND_I, 0, 4, 0 as Rotation, baseShape);
  ...
  describe("toData", () => {
    it("retourne un PieceData fidèle aux propriétés de la piece", () => {
      const piece = new Piece(KIND_I, 7, 8, 2 as Rotation, baseShape);
